import{h as z,i as F,r as H,k as J,_ as K,n,j as g,t as L,A as u,v as W,w as y,ae as M,af as N,C as V,E as $,H as q,J as w}from"./index-Dsl0fOng.js";function A(e){return z("MuiCircularProgress",e)}F("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","circle","circleDeterminate","circleIndeterminate","circleDisableShrink"]);const B=["className","color","disableShrink","size","style","thickness","value","variant"];let d=e=>e,P,_,S,I;const t=44,G=N(P||(P=d`
  0% {
