import{h as v,i as f,r as d,k as y,_ as m,n as l,j as b,t as C,v as x,w as T,aS as J,aG as S,aH as L,R as w,U as k}from"./index-DRJo8smH.js";function V(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function q(t){return parseFloat(t)}function Q(t){return v("MuiSkeleton",t)}f("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const Y=["animation","className","component","height","style","variant","width"];let N=t=>t,B,P,O,X;const Z=t=>{const{classes:e,variant:o,animation:a,hasChildren:n,width:s,height:r}=t;return x({root:["root",o,a,n&&"withChildren",n&&!s&&"fitContent",n&&!r&&"heightAuto"]},Q,e)},tt=L(B||(B=N`
  0% {
    opacity: 1;
  }
